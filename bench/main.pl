...
bench(day10, Raw) :- !,
    time_call("parse", day10:parse_input(Raw, Parsed)),
    time_call("part1", day10:part1(Parsed, A1)),
    time_call("part2", day10:part2(Parsed, A2)),
    format("day10  part1=~w  part2=~w~n", [A1, A2]).
bench(day11, Raw) :- !,
    time_call("parse", day11:parse_input(Raw, Parsed)),
    time_call("part1", day11:part1(Parsed, A1)),
    time_call("part2", day11:part2(Parsed, A2)),
    format("day11  part1=~w  part2=~w~n", [A1, A2]).
bench(day12, Raw) :- !,
    time_call("parse", day12:parse_input(Raw, Parsed)),
    time_call("part1", day12:part1(Parsed, A1)),
    time_call("part2", day12:part2(Parsed, A2)),
    format("day12  part1=~w  part2=~w~n", [A1, A2]).
bench(day13, Raw) :- !,
    time_call("parse", day13:parse_input(Raw, Parsed)),
    time_call("part1", day13:part1(Parsed, A1)),
    time_call("part2", day13:part2(Parsed, A2)),
    format("day13  part1=~w  part2=~w~n", [A1, A2]).
bench(Day, _) :-
